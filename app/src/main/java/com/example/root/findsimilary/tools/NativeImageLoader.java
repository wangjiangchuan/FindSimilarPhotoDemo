package com.example.root.findsimilary.tools;
...
public class NativeImageLoader {
    ...
    private NativeImageLoader(){
        ...
        //用最大内存的1/4来存储图片
        final int cacheSize = maxMemory / 5 * 2;
     ...
     * @return
     */
    public Bitmap decodeThumbBitmapForFileTest(Resources res, int id, int viewWidth, int viewHeight){
